...
const BlogPostPage = () => {
  ...
  return (
    <article className="min-h-screen bg-slate-950 text-slate-100 selection:bg-amber-500 selection:text-slate-950 font-sans">
      <Helmet>
      ...
      <section className="relative min-h-[90vh] md:min-h-screen flex flex-col justify-end pb-16 pt-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          >
            <Link 
              to="/" 
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white text-xs font-semibold backdrop-blur-md transition-all group"
            >
            ...
            <Link 
              to="/blog" 
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-slate-300 hover:text-white text-xs font-medium backdrop-blur-sm transition-all"
            >
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-8 leading-relaxed font-light max-w-4xl">
              {blog.excerpt}
            </p>
            
            {/* Meta Row */}
            <div className="flex flex-wrap items-center gap-6 text-xs sm:text-sm font-medium text-slate-400 pt-6 border-t border-white/15">
      ...
      {/* ─── ARTICLE CONTENT BODY (High Legibility Editorial) ─── */}
      <section className="bg-slate-900 py-16 sm:py-24 px-4 sm:px-6 lg:px-8 border-t border-white/10">
        <div className="max-w-3xl mx-auto">
          ...
          <motion.div 
            ...
            className="prose prose-lg prose-invert max-w-none 
              ...
              prose-h2:text-2xl sm:prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:border-b prose-h2:border-white/10 prose-h2:pb-3
              prose-h3:text-xl sm:prose-h3:text-2xl prose-h3:text-amber-300 prose-h3:mt-8
              prose-p:text-slate-300 prose-p:leading-relaxed prose-p:text-lg
              prose-a:text-amber-400 hover:prose-a:text-amber-300 prose-a:underline
              prose-img:rounded-xl prose-img:border prose-img:border-white/10 prose-img:shadow-2xl
              prose-strong:text-white prose-strong:font-bold
              prose-ul:text-slate-300 prose-li:marker:text-amber-400"
            dangerouslySetInnerHTML={{ __html: blog.content }}
          />
          
          {/* ─── AUTHOR & PUBLICATION SIGN-OFF ─── */}
          <div className="mt-16 p-6 sm:p-8 rounded-xl bg-slate-950/80 border border-white/10 flex flex-col sm:flex-row items-center sm:items-start gap-5">
            <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-amber-500 to-orange-400 flex items-center justify-center text-slate-950 font-bold text-xl flex-shrink-0 shadow-lg shadow-amber-500/20">
              {blog.author.charAt(0)}
            </div>
            <div className="text-center sm:text-left">
              <h4 className="text-lg font-bold text-white mb-1">{blog.author}</h4>
              <p className="text-xs uppercase tracking-wider text-amber-400 font-semibold mb-2">CEO & Restaurant Operator — Skewer POS</p>
          ...
          <div className="mt-12 p-8 sm:p-10 rounded-2xl bg-gradient-to-br from-blue-950/90 via-slate-950 to-slate-900 border border-blue-500/30 text-center relative overflow-hidden shadow-2xl">
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a 
                  ...
                  className="w-full sm:w-auto px-7 py-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm transition-all shadow-lg shadow-blue-600/30"
                >
                  Start 100 Free Orders Now
                </a>
                <Link 
                  to="/" 
                  className="w-full sm:w-auto px-7 py-3 rounded-lg bg-white/10 hover:bg-white/15 text-white font-semibold text-sm border border-white/20 transition-all flex items-center justify-center gap-2"
                >
