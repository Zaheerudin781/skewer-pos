      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <img src="/logo.png" alt="Skewer POS Logo" className="h-10 w-auto object-contain transition-transform group-hover:scale-105" />
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              className="hidden md:flex items-center justify-center gap-2 text-sm font-medium text-[#25D366] bg-transparent border border-[#25D366] px-6 py-2.5 rounded-sm btn-hollow btn-hollow-green"
            >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white/95 backdrop-blur-md shadow-xl absolute top-full left-0 w-full py-4 px-4 flex flex-col gap-4">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 text-sm font-medium text-[#25D366] bg-transparent border border-[#25D366] px-6 py-2.5 rounded-sm btn-hollow btn-hollow-green"
          >
