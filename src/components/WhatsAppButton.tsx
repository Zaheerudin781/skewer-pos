...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[999] flex items-center group pointer-events-auto">
      {/* Tooltip on hover */}
      <span className="hidden sm:inline-block mr-3 px-3 py-1.5 bg-slate-900/95 text-white text-xs font-semibold rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap backdrop-blur-md border border-slate-700">
      ...
      <div className="relative">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.92 }}
          className="relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white shadow-[0_10px_25px_rgba(37,211,102,0.6)] border-2 border-white transition-colors duration-200 cursor-pointer"
        >
